...
public class RotatedDimensionEntity extends RotatedDimension implements Entity {

    private final static String ENTITY_CLASS = "0\nDIMENSION\n";


    public RotatedDimensionEntity() {
    }

    public RotatedDimensionEntity(RotatedDimension dimension) {
        super(dimension.getDefPoint(), dimension.getMidPoint(), dimension.getPoint1(), dimension.getPoint2(), dimension.getAngle(), dimension.getColor(), dimension.getLayer(), dimension.getFontSize(), dimension.getText());
    }


   /* public RotatedDimensionEntity(Point defPoint, Point midPoint, Point p1, Point p2, String layer) {
        super(defPoint, midPoint, p1, p2);
        this.layer = layer;
    }

    public RotatedDimensionEntity(Point defPoint, Point midPoint, Point p1, Point p2) {
