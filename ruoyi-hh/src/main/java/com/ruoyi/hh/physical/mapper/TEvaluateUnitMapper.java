 ...
 * @date 2022-08-26
 */
public interface TEvaluateUnitMapper 
{
    /**
     * 查询评价单元信息
     * 
     ...
     * @return 列表
     */
    public List<TEvaluateUnit> getJudgeReportInfo(@Param("workfaceid") Integer workfaceid,@Param("evaluateunitid") Integer evaluateunitid);
}
