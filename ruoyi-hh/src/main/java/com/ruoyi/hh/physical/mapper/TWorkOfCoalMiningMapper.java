...
public interface TWorkOfCoalMiningMapper {
     ...
     * @return 结果
     */
    public int insertTWorkOfCoalMining(TWorkOfCoalMining tWorkOfCoalMining);
     ...
     * @return 结果
     */
    public int updateTWorkOfCoalMining(TWorkOfCoalMining tWorkOfCoalMining);
