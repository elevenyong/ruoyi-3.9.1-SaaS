        ...
        <el-row>
          <el-card>
            ...
            <div class="el-table el-table--enable-row-hover el-table--medium">
              <div ref="zkndstats" style="height: 60vh"/>
            </div>
          </el-card>
        </el-row>
        <!--        <el-row>
                  <el-card>
                    &lt;!&ndash; <div slot="header"><span>最新抽采浓度钻孔数量占比</span></div> &ndash;&gt;
                    <div class="el-table el-table&#45;&#45;enable-row-hover el-table&#45;&#45;medium">
...
<script>
import { cleanOperlog, delOperlog, groupByCount, list } from '@/api/monitor/operlog'
...
export default {
  ...
  mounted() {
    //this.initCharts()
    this.getGroupByCount()
  },
  methods: {
    initCharts(countData) {
    ...
    getGroupByCount() {
      let _this = this
      groupByCount().then(response => {
        if (response.code === 200) {
          _this.initCharts(response.data)
        }
      })
    },
    /** 查询登录日志 */
