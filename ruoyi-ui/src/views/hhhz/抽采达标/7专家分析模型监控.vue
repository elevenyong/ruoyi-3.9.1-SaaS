<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="actual_boreholeList" @selection-change="handleSelectionChange"
            ...
            <el-table-column label="抽采模型" align="center" prop="ccmx" />
            <el-table-column label="模型分类" align="center" prop="mxfl" />
            <el-table-column label="模型定义" align="center" prop="mxdy" />
            <el-table-column label="告警信息" align="center" prop="gjxx" />
            <el-table-column label="关联测点" align="center" prop="glcd" />
            <el-table-column label="今日报警" align="center" prop="jrbj" />
