      ...
      <el-col :span="6" class="card-box">
        <el-card style="height: 85vh">
          ...
          <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" label-width="188px">
            ...
            <el-form-item label="控制距离范围起点" prop="lStart">
              <el-input
                v-model="queryParams.lStart"
                placeholder="控制距离范围起点"
              >
                <template slot="append">m</template>
              </el-input>
            </el-form-item>
            <el-form-item label="控制距离范围终点" prop="lEnd">
              <el-input
                v-model="queryParams.lEnd"
                placeholder="控制距离范围终点"
              >
                <template slot="append">m</template>
              </el-input>
            </el-form-item>
...
<script>
import { drillingReMiningArea } from '@/api/hhhz/drillingdes'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      drillingReMiningArea(this.queryParams).then(response => {
