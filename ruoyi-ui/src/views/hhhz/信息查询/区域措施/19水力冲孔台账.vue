<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="区段名称" align="center" prop="zoneName"/>
      ...
      <el-table-column label="开始冲孔时间" align="center" prop="timeBeginFlushing"/>
      <el-table-column label="结束冲孔时间" align="center" prop="timeEndFlushing"/>
      ...
      <el-table-column label="实际冲煤量" align="center" prop="actualCoalAmountFlushed"/>
      <el-table-column label="冲孔过程中异常标注" align="center" prop="exceptionPhenomena"/>
      <el-table-column label="冲孔施工人员" align="center" prop="personConstructionFlushing"/>
      <el-table-column label="跟班人员" align="center" prop="otherPerson"/>
      <el-table-column label="冲孔负责人" align="center" prop="chargehandFlushing"/>
      <el-table-column label="冲孔备注" align="center" prop="remarkFlushing"/>
  ...
  methods: {
    ...
    getList() {
      ...
      if (this.queryCheckingdate && this.queryCheckingdate.length >= 1) {
        this.queryParams.terminalholedate1 = this.queryCheckingdate[0]
          .toLocaleString()
          .replaceAll('/', '-')
        this.queryParams.terminalholedate2 = this.queryCheckingdate[1]
          .toLocaleString()
          .replaceAll('/', '-')
      } else {
        delete this.queryParams.terminalholedate1
        delete this.queryParams.terminalholedate1
      }
    ...
    handleExport() {
      this.download(
        'tActualFlushing/exportFlushingStandingBook',
        {},
        `水力冲孔台账_${new Date().getTime()}.xlsx`
      )
    }
  }
}
