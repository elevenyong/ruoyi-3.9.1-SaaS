    ...
    <!-- <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['/:tGasContentPressure:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['/:tGasContentPressure:edit']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['/:tGasContentPressure:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['/:tGasContentPressure:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
...
<!--      <el-table-column type="selection" width="55" align="center"/>
      ...
      />
      <el-table-column label="钻场编号" align="center" prop="groupNo"/>
      <el-table-column label="钻孔序号" align="center" prop="boreholeNo"/>
      <el-table-column label="取样深度" align="center" prop="samplingDepth"/>
      <el-table-column label="倾角(°)" align="center" prop="inclinationAngle"/>
      <el-table-column label="夹角(°)" align="center" prop="azimuthAngle"/>
  ...
  methods: {
    ...
    handleExport() {
      this.download(
        ...
        {},
        `瓦斯含量、压力_${new Date().getTime()}.xlsx`
      )
    }
  }
}
