<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
            ...
            <el-form-item label="验收日期" prop="checkingDate">
                <el-date-picker v-model="queryParams.checkingDate" type="date">
                </el-date-picker>
            </el-form-item>
            <el-form-item>
 ...
 -->
            <el-table-column label="序号" align="center" prop="groupNo" />
            <el-table-column label="钻场及编号" align="center" prop="boreholeNo" />
            <el-table-column label="孔号" align="center" prop="drillingDate"></el-table-column>
            <el-table-column label="拔钻日期" align="center" prop="borediameter">
                <template slot-scope="scope">
                    <span>{{ parseTime(scope.row.drillingDate, '{y}-{m}-{d}') }}</span>
                </template>
            </el-table-column>
            <el-table-column label="单位" align="center" prop="azimuthAngle" />
            <el-table-column label="施工地点" align="center" prop="inclinationAngle" />
            <el-table-column label="钻孔好" align="center" prop="depth1stRockSeamStart" />
            <el-table-column label="孔深(m)" align="center" prop="depth2stRockSeamStart" />
            <el-table-column label="见煤长度(m)" align="center" prop="depth3stcoalseamstart" />
            <el-table-column label="冲煤量(t)" align="center" prop="depth1stCoalSeamStart" />
            <el-table-column label="单孔每米冲煤量(t/m)" align="center" prop="depth1stCoalSeamStart" />
            <el-table-column label="当日单机进尺(m)" align="center" prop="depth1stCoalSeamStart" />
            <el-table-column label="当月单机总进尺(m)" align="center" prop="depth1stCoalSeamStart" />
            <el-table-column label="当月单机总见煤长度(m)" align="center" prop="depth1stCoalSeamStart" />
            <el-table-column label="当月单机总冲煤量(t)" align="center" prop="depth1stCoalSeamStart" />
            <el-table-column label="当月累计施工钻孔数" align="center" prop="depth1stCoalSeamStart" />
