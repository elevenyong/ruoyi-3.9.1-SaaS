<template>
  <div class="app-container">
    ...
    >
      ...
      <!--      <el-form-item label="查询时间" prop="checkingDate" label-width="98px">
              <el-date-picker
      ...
      <el-form-item label="查询时间" prop="zkdd">
        <el-date-picker
          v-model="queryParams.date"
          type="monthrange"
          range-separator="至"
      ...
      <el-form-item label="压力类型" prop="zkdd">
        <el-select :value="queryParams.ptype">
          <el-option v-for="item in pressureType"
                     :key="pressureType.value"
                     :label="pressureType.label"
                     :value="pressureType.value">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="报表类型" prop="zkdd">
        <el-select :value="queryParams.ttype">
          <el-option v-for="item in tableType"
                     :key="tableType.value"
...
export default {
  ...
  methods: {
    ...
    createPDF(date, tbody) {
      ...
      this.doc.text('瓦斯抽采月报表', 150, 20, null, null, 'center')
