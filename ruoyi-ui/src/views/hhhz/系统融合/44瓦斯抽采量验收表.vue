  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item>
        ...
        <el-button type="primary" icon="el-icon-search" size="mini" @click="handleQuery">导出</el-button>
    ...
    <el-table v-loading="false" :data="geofaultList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="月份" align="center" prop="name"/>
      <el-table-column label="抽采量(m³)" align="center" prop="azimuth">
        <el-table-column label="光力地面泵站1号(m³)" align="center" prop="azimuth"></el-table-column>
        <el-table-column label="光力地面泵站2号(m³)" align="center" prop="azimuth"></el-table-column>
        <el-table-column label="光力井下泵站1号(m³)" align="center" prop="azimuth"></el-table-column>
        <el-table-column label="光力井下泵站2号(m³)" align="center" prop="azimuth"></el-table-column>
        <el-table-column label="累计(m³)" align="center" prop="azimuth"></el-table-column>
      </el-table-column>
      <el-table-column label="详细内容" align="center" prop="inclination"/>
      <el-table-column label="验收表" align="center" prop="centerX"/>
