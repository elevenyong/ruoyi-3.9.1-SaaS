<template>
    <div id="app">
        <div class="wl-gantt-demo">
            <wlGantt ref="wl-gantt-demo" use-real-time end-date="2019-11-02" start-date="2019-9-06"
                date-type="monthAndDay" :data="data" :columns="columns" :contextMenuOptions="contextMenuOptions"
                @selection-change="selectionChange" @expand-change="expandChange" @timeChange="timeChange"
                @taskRemove="taskRemove" @preChange="preChange" @taskAdd="taskAdd">
                <template slot="prv">
              ...
              item.children.concat([
                {
                  pid: item.id,
                  //id: "###",
                  id:item.id+Date.parse(new Date()),
                  name: "一轮新月",
                  startDate: "2019-10-11",
                  endDate: "2019-10-19"
                }
